...
export default class extends React.Component {
  ...
  render() {
    let about = <p>Ma passion pour les technologies du <strong>Web et Mobile</strong> s'est éveillé au cours du D.U.T Services et Réseaux de Communication. J'ai pu pratiquer le <strong>développement d'application</strong> mais aussi toutes les disciplines rencontrées au cours de l'élaboration d'un site web dans les différents réalisés.
     ...
     Aujourd'hui titulaire d'un <strong>BAC+5 Chef de projet Web</strong>, je suis actuelement à la recherche d'un travail.
    </p>;
    ...
    let gestion = <p>Conception d'<strong>API RESTfull</strong>, d'architecture <strong>MVC</strong> ... Maîtrise des langages et frameworks serveurs JavaScript (<strong>NodeJS</strong>), PHP (<strong>CodeIgniter, Symfony, Zend</strong>), Python (<strong>Django</strong>), Ruby (<strong>Ruby On Rails</strong>) ... Conception et migration de serveur sur les environements <strong>Ubuntu</strong>, <strong>Debian</strong>, <strong>Windows</strong>. </p>;
    return (
